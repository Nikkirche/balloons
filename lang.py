lang_ru = {
    ...
    'back': 'Вернуться',
    'this_is_you': 'Это вы',
    'disabled_reg_message' : "Ручная регистрация запрещена - для выдачи логина и пароля обратитесь к администраторам",
    'wrong_login' : 'неверный пароль или логин',
    'wrong_register' : 'это логин уже используется',
    'error_add' : 'Ошибка при добавлении нового волонтёра',
    'add_volunteers_header' : 'Добавить нового волонтёра',
    '': ''
}
